...
struct WelcomeSheetView: View {
    ...
    let welcomeFeatures = [
        WelcomeSheetFeatureRow(icon: "wave.3.up", header: "welcome_header_1", subtitle: "welcome_subtitle_1"),
        WelcomeSheetFeatureRow(icon: "arcade.stick.console.fill", header: "welcome_header_2", subtitle: "welcome_subtitle_2"),
        WelcomeSheetFeatureRow(icon: "wand.and.sparkles", header: "welcome_header_3", subtitle: "welcome_subtitle_3")
    ]
